...
function galleryImage ($path, $max_x, $justurl = FALSE) {
 ...
 // include_once("config.inc.php");
  ...
  else return "<img src=\"$targetImagePath\" width=\"$imageSize[0]\" height=\"$imageSize[1]\" border=\"0\" style=\"border:1px solid #000000;\"><input type=\"hidden\" name=\"fotocache\" value=\"$targetImagePath\">";
