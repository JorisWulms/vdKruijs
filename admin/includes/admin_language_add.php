...
<div class="content" id="newInputs">
	<form method="post" action="index.php?action=language" id="form" enctype="multipart/form-data"><input type="hidden" name="addtaal" value="true">
		<table class="form">
			<tr>
				<td width="20%">Code:</td><td><input type="text" name="code" value="" /></td>
			</tr>
			<tr>
				<td width="20%">Taal:</td><td><input type="text" name="taal" value="" /></td>
			</tr>
			<tr>
				<td>Actief:</td>
				<td>
