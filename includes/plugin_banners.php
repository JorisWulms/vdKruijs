...
////////////////////////////
	if($resBannerSettings['layoutType']==7){
		...
		if(mysqli_num_rows($getPageBanners)){
			...
			echo '<div id="bannerContainer" class="customBannerPerPage'.$additionPage.'" style="background-image: url(images/banners/'.$rowBanner['bannerSrc'].');background-size:cover;'.$bannerBackgroundColor.$bannerPadding.'">';
